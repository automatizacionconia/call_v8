                ...
                <v-row>
                    <v-col cols="12">
                        ...
                        >
                            ...
                            <template v-slot:item.agen_estado="{ item }">
                                <v-chip
                                    small
                                    dark
                                    :color="item.agen_estado ? 'green' : 'red'"
                                >
                                    {{ item.agen_estado ? 'Activo' : 'Inactivo' }}
                                </v-chip>
                            </template>
                        </v-data-table>
                    </v-col>
    ...
    methods: {
        ...
        async getDataApi() {
            try {
                ...
                const response = await AgenteService.index(this.dataFilters);
